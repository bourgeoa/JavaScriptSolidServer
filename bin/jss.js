...
program
  ...
  .option('--conneg', 'Content negotiation for generic Accept (explicit Turtle/N3 is always honored)')
  .option('--no-conneg', 'JSON-LD native defaults for generic Accept (explicit Turtle/N3 still honored)')
